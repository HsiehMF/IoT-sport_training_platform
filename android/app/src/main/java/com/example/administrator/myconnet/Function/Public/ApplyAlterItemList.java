...
public class ApplyAlterItemList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apply_alter_item_list);
        ...
        TextView textView1 = (TextView) findViewById(R.id.textView77);
        TextView textView2 = (TextView) findViewById(R.id.tv_apply_alter_item_list_schedule_name);
        textView1.setTypeface(typeface, typeface.BOLD);
        textView2.setTypeface(typeface,typeface.BOLD);

        Button button1 = (Button) findViewById(R.id.button47);
        Button button2 = (Button) findViewById(R.id.button48);
    ...
    private void init() {
        ...
        LinearLayout linearLayout_EnterItemList = (LinearLayout) findViewById(R.id.linearLayout_apply_alter_item_list);

        String schedule_name = bundle.getString("schedule_name");
        TextView tv_schedule_name = (TextView) findViewById(R.id.tv_apply_alter_item_list_schedule_name);
    ...
    public void applyAlterCancel(View view) { finish(); }
