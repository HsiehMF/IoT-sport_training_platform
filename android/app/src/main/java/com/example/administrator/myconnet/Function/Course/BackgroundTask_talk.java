...
public class BackgroundTask_talk extends AsyncTask<String,Void,String> {  // AsyncTask<params,progress,result>

    Context ctx;
    public BackgroundTask_talk(Context ctx)
    {
        this.ctx =ctx;
    }
    @Override
    ...
    protected String doInBackground(String... params) {
        ...
        String new_url1 = "http://140.127.218.198:8080/webapp/talk.php";
        String new_url2 = "http://140.127.218.198:8080/webapp/coach_talk.php";

        String method = params[0];

        if (method.equals("player_talk")) {
        ...
        } else if (method.equals("coach_talk")) {
